...
SIGNAL \DECO|saida[1]~1_combout\ : std_logic;
SIGNAL \DECO|saida[2]~2_combout\ : std_logic;
...
SIGNAL \DECO|saida[0]~0_combout\ : std_logic;
...
SIGNAL \DECO|ALT_INV_saida[1]~1_combout\ : std_logic;
...
\DECO|ALT_INV_saida[1]~1_combout\ <= NOT \DECO|saida[1]~1_combout\;
...
\DECO|saida[1]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECO|saida[1]~1_combout\ = (!\PC|DOUT\(0) & (!\PC|DOUT\(1) & !\PC|DOUT\(2)))
...
PORT MAP (
	...
	datab => \PC|ALT_INV_DOUT\(1),
	datac => \PC|ALT_INV_DOUT\(2),
	combout => \DECO|saida[1]~1_combout\);

\DECO|saida[2]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECO|saida[2]~2_combout\ = !\PC|DOUT\(2) $ (((!\PC|DOUT\(0) & !\PC|DOUT\(1))))
...
PORT MAP (
	...
	datab => \PC|ALT_INV_DOUT\(1),
	datac => \PC|ALT_INV_DOUT\(2),
	combout => \DECO|saida[2]~2_combout\);
...
PORT MAP (
	...
	clrn => \DECO|ALT_INV_saida[1]~1_combout\,
	ena => \DECO|saida[2]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \REGA|DOUT\(0));
...
\DECO|saida[0]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECO|saida[0]~0_combout\ = (!\PC|DOUT\(2) & ((\PC|DOUT\(1)) # (\PC|DOUT\(0))))
...
PORT MAP (
	...
	datab => \PC|ALT_INV_DOUT\(1),
	datac => \PC|ALT_INV_DOUT\(2),
	combout => \DECO|saida[0]~0_combout\);
